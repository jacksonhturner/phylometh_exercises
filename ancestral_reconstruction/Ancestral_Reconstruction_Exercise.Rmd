...
More verbose and complete version coming soon; this is a placeholder that will be updated very shortly. 
...
There is uncertainty in the maximum likelihood model because it doesn't minimize the number of changes, but instead uses the data to determine the most likely tree, leading to uncertainty.
